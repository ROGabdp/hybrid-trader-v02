...
與 V3 的差異：
- Buy Agent Fine-tune: 1,000,000 步 (標準)
- Sell Agent Fine-tune: 300,000 步 (標準)
...
def run_finetuning():
    ...
    print("=" * 60)
    print(f"  Buy Agent:  {FINETUNE_BUY_STEPS:,} steps (標準)")
    print(f"  Sell Agent: {FINETUNE_SELL_STEPS:,} steps (標準)")
    print(f"  Output:     {V4_MODELS_PATH}")
    print("=" * 60)
